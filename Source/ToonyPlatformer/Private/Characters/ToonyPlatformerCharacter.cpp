...
void AToonyPlatformerCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AToonyPlatformerCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AToonyPlatformerCharacter::Look);
	}
	else
	{
...
void AToonyPlatformerCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AToonyPlatformerCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
